...
const mapLeadData = (lead) => {
    ...
    const lastName = findValue(['last_name', 'lname', 'surname']) || lead.full_name || 'Unknown'; // Fallback to 'Unknown' is required by Zoho
    ...
    // 1. Phone Validation (Digits only, length check?)
    // Remove non-digits
